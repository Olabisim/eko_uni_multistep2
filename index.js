...
$(document).ready(function() {
  ...
  form.append("spaces", spaces);
  form.append("parkingPrice", parkingPrice);
  form.append("cashPay", cashParkers);
  form.append("util", util);
  form.append("eventCount", count);
  form.append("eventHours", hours);
  form.append("laborRate", laborRate);
  form.append("eventLabor", eventLabor);
  ...
  // var settings = {
  //   "url": "https://parkhub-bosh-poc.bubbleapps.io/version-test/api/1.1/wf/calcTest",
  //   "method": "POST",
  //   "timeout": 0,
  //   "headers": {
  //     "Content-Type": ["application/x-www-form-urlencoded", "multipart/form-data; boundary=--------------------------669679030491539289095567"] },
  //   "processData": false,
